...
let package = Package(
    ...
    targets: [
        .target(name: "PetPlanifyCore", path: "PetPlanify", exclude: ["App/FeatureDestinationView.swift", "App/MacAppShell.swift", "App/MobileAppShell.swift", "App/PetPlanifyApp.swift", "ContentView.swift", "Core/Components", "Core/Models/AppSection.swift", "Core/PreviewData", "Core/Theme", "Features/Home", "Features/Onboarding", "Features/Settings", "Resources", "Features/Health/HealthComponents.swift", "Features/Health/HealthDashboardView.swift", "Features/Health/HealthWeightChart.swift", "Features/Health/HealthMedicationEditor.swift", "Features/Health/HealthDetailSheets.swift", "Features/Health/HealthDocumentsView.swift", "Features/Health/HealthView.swift", "Features/Health/HealthVisitEditors.swift", "Features/Nutrition/NutritionView.swift", "Features/Nutrition/NutritionEditors.swift", "Features/Training/TrainingDetailSheets.swift", "Features/Training/TrainingView.swift", "Features/Training/TrainingEditors.swift", "Features/Training/TrainingComponents.swift"], sources: [
